...
var hasAdv = {isAdv : false,originalSource : ""};
   ...
   // console.log(json);
    ...
    if(!! json[each].hasadv  ){
        ...
        if( json[each].tipoadv == "v" && !adv_already_played && each_of_played_adv != each || json[each].tipoadv == "v" && each_click ){
            ...
            if(iOS || isAndroid || isEdge() ){
				...
				hasAdv.originalSource = json[each].urlStreamSourceHls;
            }else{
                connectStrvalue = json[each].urlAdv;
				hasAdv.originalSource = json[each].urlStreamSourceDash;
            }
    ...
    if( iOS){            
        ...
        $('video').html('<source src="'+ connectStrvalue +'"  type="application/x-mpegURL" >');
						...
						{
							console.log("EDGE")
							myPlayer.src({"type":"application/x-mpegURL", "src":connectStrvalue});
						}
    else if(isAndroid){
        $('video').html('<source src="'+ connectStrvalue +'"  type="application/x-mpegURL" >');
    }
